    ...
    getInfo() {
        return {
            ...
            "targets": [{
                ...
                {
                    "name": "arduino_mega_mechatronics",
                    "options": {
                        "upload": {
                            "middlewares": [{
                                "name": "arduino",
                ...
                {
                    "name": "arduino_uno_lcd_dht11_ir_relay_sheild",
                    "options": {
                        "upload": {
                            "middlewares": [{
                                "name": "arduino",
